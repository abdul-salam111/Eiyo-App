...
@IntConverter()@JsonKey(name: "count") int? get count;@IntConverter()@JsonKey(name: "page") int? get page;@IntConverter()@JsonKey(name: "page_count") int? get pageCount;@IntConverter()@JsonKey(name: "page_size") int? get pageSize;@JsonKey(name: "products") List<Product>? get products;@IntConverter()@JsonKey(name: "skip") int? get skip;
...
@useResult
$Res call({
@IntConverter()@JsonKey(name: "count") int? count,@IntConverter()@JsonKey(name: "page") int? page,@IntConverter()@JsonKey(name: "page_count") int? pageCount,@IntConverter()@JsonKey(name: "page_size") int? pageSize,@JsonKey(name: "products") List<Product>? products,@IntConverter()@JsonKey(name: "skip") int? skip
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@IntConverter()@JsonKey(name: "count")  int? count, @IntConverter()@JsonKey(name: "page")  int? page, @IntConverter()@JsonKey(name: "page_count")  int? pageCount, @IntConverter()@JsonKey(name: "page_size")  int? pageSize, @JsonKey(name: "products")  List<Product>? products, @IntConverter()@JsonKey(name: "skip")  int? skip)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GetAllProductsModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@IntConverter()@JsonKey(name: "count")  int? count, @IntConverter()@JsonKey(name: "page")  int? page, @IntConverter()@JsonKey(name: "page_count")  int? pageCount, @IntConverter()@JsonKey(name: "page_size")  int? pageSize, @JsonKey(name: "products")  List<Product>? products, @IntConverter()@JsonKey(name: "skip")  int? skip)  $default,) {final _that = this;
switch (_that) {
case _GetAllProductsModel():
return $default(_that.count,_that.page,_that.pageCount,_that.pageSize,_that.products,_that.skip);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@IntConverter()@JsonKey(name: "count")  int? count, @IntConverter()@JsonKey(name: "page")  int? page, @IntConverter()@JsonKey(name: "page_count")  int? pageCount, @IntConverter()@JsonKey(name: "page_size")  int? pageSize, @JsonKey(name: "products")  List<Product>? products, @IntConverter()@JsonKey(name: "skip")  int? skip)?  $default,) {final _that = this;
switch (_that) {
case _GetAllProductsModel() when $default != null:
return $default(_that.count,_that.page,_that.pageCount,_that.pageSize,_that.products,_that.skip);case _:
  return null;
...
class _GetAllProductsModel implements GetAllProductsModel {
  const _GetAllProductsModel({@IntConverter()@JsonKey(name: "count") this.count, @IntConverter()@JsonKey(name: "page") this.page, @IntConverter()@JsonKey(name: "page_count") this.pageCount, @IntConverter()@JsonKey(name: "page_size") this.pageSize, @JsonKey(name: "products") final  List<Product>? products, @IntConverter()@JsonKey(name: "skip") this.skip}): _products = products;
  factory _GetAllProductsModel.fromJson(Map<String, dynamic> json) => _$GetAllProductsModelFromJson(json);

@override@IntConverter()@JsonKey(name: "count") final  int? count;
@override@IntConverter()@JsonKey(name: "page") final  int? page;
@override@IntConverter()@JsonKey(name: "page_count") final  int? pageCount;
@override@IntConverter()@JsonKey(name: "page_size") final  int? pageSize;
...
@override@IntConverter()@JsonKey(name: "skip") final  int? skip;
...
@JsonKey(name: "brands") String? get brands;@JsonKey(name: "categories") String? get categories;@JsonKey(name: "categories_tags") List<String>? get categoriesTags;@JsonKey(name: "code") String? get code;@JsonKey(name: "image_front_small_url") String? get imageFrontSmallUrl;@JsonKey(name: "ingredients_text") String? get ingredientsText;@JsonKey(name: "nutriments") Nutriments? get nutriments;@JsonKey(name: "nutriscore_grade") String? get nutriscoreGrade;@IntConverter()@JsonKey(name: "nutriscore_score") int? get nutriscoreScore;@JsonKey(name: "product_name") String? get productName;@JsonKey(name: "quantity") String? get quantity;
...
@useResult
$Res call({
@JsonKey(name: "brands") String? brands,@JsonKey(name: "categories") String? categories,@JsonKey(name: "categories_tags") List<String>? categoriesTags,@JsonKey(name: "code") String? code,@JsonKey(name: "image_front_small_url") String? imageFrontSmallUrl,@JsonKey(name: "ingredients_text") String? ingredientsText,@JsonKey(name: "nutriments") Nutriments? nutriments,@JsonKey(name: "nutriscore_grade") String? nutriscoreGrade,@IntConverter()@JsonKey(name: "nutriscore_score") int? nutriscoreScore,@JsonKey(name: "product_name") String? productName,@JsonKey(name: "quantity") String? quantity
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: "brands")  String? brands, @JsonKey(name: "categories")  String? categories, @JsonKey(name: "categories_tags")  List<String>? categoriesTags, @JsonKey(name: "code")  String? code, @JsonKey(name: "image_front_small_url")  String? imageFrontSmallUrl, @JsonKey(name: "ingredients_text")  String? ingredientsText, @JsonKey(name: "nutriments")  Nutriments? nutriments, @JsonKey(name: "nutriscore_grade")  String? nutriscoreGrade, @IntConverter()@JsonKey(name: "nutriscore_score")  int? nutriscoreScore, @JsonKey(name: "product_name")  String? productName, @JsonKey(name: "quantity")  String? quantity)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Product() when $default != null:
...
class _Product implements Product {
  const _Product({@JsonKey(name: "brands") this.brands, @JsonKey(name: "categories") this.categories, @JsonKey(name: "categories_tags") final  List<String>? categoriesTags, @JsonKey(name: "code") this.code, @JsonKey(name: "image_front_small_url") this.imageFrontSmallUrl, @JsonKey(name: "ingredients_text") this.ingredientsText, @JsonKey(name: "nutriments") this.nutriments, @JsonKey(name: "nutriscore_grade") this.nutriscoreGrade, @IntConverter()@JsonKey(name: "nutriscore_score") this.nutriscoreScore, @JsonKey(name: "product_name") this.productName, @JsonKey(name: "quantity") this.quantity}): _categoriesTags = categoriesTags;
...
@override@IntConverter()@JsonKey(name: "nutriscore_score") final  int? nutriscoreScore;
...
@NumConverter()@JsonKey(name: "carbohydrates") double? get carbohydrates;@NumConverter()@JsonKey(name: "carbohydrates_100g") double? get carbohydrates100G;@NumConverter()@JsonKey(name: "carbohydrates_serving") double? get carbohydratesServing;@JsonKey(name: "carbohydrates_unit") String? get carbohydratesUnit;@NumConverter()@JsonKey(name: "carbohydrates_value") double? get carbohydratesValue;@NumConverter()@JsonKey(name: "energy") double? get energy;@NumConverter()@JsonKey(name: "energy-kcal") double? get energyKcal;@NumConverter()@JsonKey(name: "energy-kcal_100g") double? get energyKcal100G;@NumConverter()@JsonKey(name: "energy-kcal_serving") double? get energyKcalServing;@JsonKey(name: "energy-kcal_unit") String? get energyKcalUnit;@NumConverter()@JsonKey(name: "energy-kcal_value") double? get energyKcalValue;@NumConverter()@JsonKey(name: "energy-kcal_value_computed") double? get energyKcalValueComputed;@NumConverter()@JsonKey(name: "energy-kj") double? get energyKj;@NumConverter()@JsonKey(name: "energy-kj_100g") double? get energyKj100G;@NumConverter()@JsonKey(name: "energy-kj_serving") double? get energyKjServing;@JsonKey(name: "energy-kj_unit") String? get energyKjUnit;@NumConverter()@JsonKey(name: "energy-kj_value") double? get energyKjValue;@NumConverter()@JsonKey(name: "energy-kj_value_computed") double? get energyKjValueComputed;@NumConverter()@JsonKey(name: "energy_100g") double? get energy100G;@NumConverter()@JsonKey(name: "energy_serving") double? get energyServing;@JsonKey(name: "energy_unit") String? get energyUnit;@NumConverter()@JsonKey(name: "energy_value") double? get energyValue;@NumConverter()@JsonKey(name: "fat") double? get fat;@NumConverter()@JsonKey(name: "fat_100g") double? get fat100G;@NumConverter()@JsonKey(name: "fat_serving") double? get fatServing;@JsonKey(name: "fat_unit") String? get fatUnit;@NumConverter()@JsonKey(name: "fat_value") double? get fatValue;@NumConverter()@JsonKey(name: "fiber") double? get fiber;@NumConverter()@JsonKey(name: "fiber_100g") double? get fiber100G;@NumConverter()@JsonKey(name: "fiber_serving") double? get fiberServing;@JsonKey(name: "fiber_unit") String? get fiberUnit;@NumConverter()@JsonKey(name: "fiber_value") double? get fiberValue;@NumConverter()@JsonKey(name: "fruits-vegetables-legumes-estimate-from-ingredients_100g") double? get fruitsVegetablesLegumesEstimateFromIngredients100G;@NumConverter()@JsonKey(name: "fruits-vegetables-legumes-estimate-from-ingredients_serving") double? get fruitsVegetablesLegumesEstimateFromIngredientsServing;@NumConverter()@JsonKey(name: "fruits-vegetables-nuts-estimate-from-ingredients_100g") double? get fruitsVegetablesNutsEstimateFromIngredients100G;@NumConverter()@JsonKey(name: "fruits-vegetables-nuts-estimate-from-ingredients_serving") double? get fruitsVegetablesNutsEstimateFromIngredientsServing;@IntConverter()@JsonKey(name: "nutrition-score-fr") int? get nutritionScoreFr;@IntConverter()@JsonKey(name: "nutrition-score-fr_100g") int? get nutritionScoreFr100G;@NumConverter()@JsonKey(name: "proteins") double? get proteins;@NumConverter()@JsonKey(name: "proteins_100g") double? get proteins100G;@NumConverter()@JsonKey(name: "proteins_serving") double? get proteinsServing;@JsonKey(name: "proteins_unit") String? get proteinsUnit;@NumConverter()@JsonKey(name: "proteins_value") double? get proteinsValue;@NumConverter()@JsonKey(name: "salt") double? get salt;@NumConverter()@JsonKey(name: "salt_100g") double? get salt100G;@NumConverter()@JsonKey(name: "salt_serving") double? get saltServing;@JsonKey(name: "salt_unit") String? get saltUnit;@NumConverter()@JsonKey(name: "salt_value") double? get saltValue;@NumConverter()@JsonKey(name: "saturated-fat") double? get saturatedFat;@NumConverter()@JsonKey(name: "saturated-fat_100g") double? get saturatedFat100G;@NumConverter()@JsonKey(name: "saturated-fat_serving") double? get saturatedFatServing;@JsonKey(name: "saturated-fat_unit") String? get saturatedFatUnit;@NumConverter()@JsonKey(name: "saturated-fat_value") double? get saturatedFatValue;@NumConverter()@JsonKey(name: "sodium") double? get sodium;@NumConverter()@JsonKey(name: "sodium_100g") double? get sodium100G;@NumConverter()@JsonKey(name: "sodium_serving") double? get sodiumServing;@JsonKey(name: "sodium_unit") String? get sodiumUnit;@NumConverter()@JsonKey(name: "sodium_value") double? get sodiumValue;@NumConverter()@JsonKey(name: "sugars") double? get sugars;@NumConverter()@JsonKey(name: "sugars_100g") double? get sugars100G;@NumConverter()@JsonKey(name: "sugars_serving") double? get sugarsServing;@JsonKey(name: "sugars_unit") String? get sugarsUnit;@NumConverter()@JsonKey(name: "sugars_value") double? get sugarsValue;@NumConverter()@JsonKey(name: "calcium") double? get calcium;@NumConverter()@JsonKey(name: "calcium_100g") double? get calcium100G;@JsonKey(name: "calcium_label") String? get calciumLabel;@NumConverter()@JsonKey(name: "calcium_serving") double? get calciumServing;@JsonKey(name: "calcium_unit") String? get calciumUnit;@NumConverter()@JsonKey(name: "calcium_value") double? get calciumValue;@JsonKey(name: "fat_label") String? get fatLabel;@IntConverter()@JsonKey(name: "nova-group") int? get novaGroup;@IntConverter()@JsonKey(name: "nova-group_100g") int? get novaGroup100G;@IntConverter()@JsonKey(name: "nova-group_serving") int? get novaGroupServing;
...
@useResult
$Res call({
@NumConverter()@JsonKey(name: "carbohydrates") double? carbohydrates,@NumConverter()@JsonKey(name: "carbohydrates_100g") double? carbohydrates100G,@NumConverter()@JsonKey(name: "carbohydrates_serving") double? carbohydratesServing,@JsonKey(name: "carbohydrates_unit") String? carbohydratesUnit,@NumConverter()@JsonKey(name: "carbohydrates_value") double? carbohydratesValue,@NumConverter()@JsonKey(name: "energy") double? energy,@NumConverter()@JsonKey(name: "energy-kcal") double? energyKcal,@NumConverter()@JsonKey(name: "energy-kcal_100g") double? energyKcal100G,@NumConverter()@JsonKey(name: "energy-kcal_serving") double? energyKcalServing,@JsonKey(name: "energy-kcal_unit") String? energyKcalUnit,@NumConverter()@JsonKey(name: "energy-kcal_value") double? energyKcalValue,@NumConverter()@JsonKey(name: "energy-kcal_value_computed") double? energyKcalValueComputed,@NumConverter()@JsonKey(name: "energy-kj") double? energyKj,@NumConverter()@JsonKey(name: "energy-kj_100g") double? energyKj100G,@NumConverter()@JsonKey(name: "energy-kj_serving") double? energyKjServing,@JsonKey(name: "energy-kj_unit") String? energyKjUnit,@NumConverter()@JsonKey(name: "energy-kj_value") double? energyKjValue,@NumConverter()@JsonKey(name: "energy-kj_value_computed") double? energyKjValueComputed,@NumConverter()@JsonKey(name: "energy_100g") double? energy100G,@NumConverter()@JsonKey(name: "energy_serving") double? energyServing,@JsonKey(name: "energy_unit") String? energyUnit,@NumConverter()@JsonKey(name: "energy_value") double? energyValue,@NumConverter()@JsonKey(name: "fat") double? fat,@NumConverter()@JsonKey(name: "fat_100g") double? fat100G,@NumConverter()@JsonKey(name: "fat_serving") double? fatServing,@JsonKey(name: "fat_unit") String? fatUnit,@NumConverter()@JsonKey(name: "fat_value") double? fatValue,@NumConverter()@JsonKey(name: "fiber") double? fiber,@NumConverter()@JsonKey(name: "fiber_100g") double? fiber100G,@NumConverter()@JsonKey(name: "fiber_serving") double? fiberServing,@JsonKey(name: "fiber_unit") String? fiberUnit,@NumConverter()@JsonKey(name: "fiber_value") double? fiberValue,@NumConverter()@JsonKey(name: "fruits-vegetables-legumes-estimate-from-ingredients_100g") double? fruitsVegetablesLegumesEstimateFromIngredients100G,@NumConverter()@JsonKey(name: "fruits-vegetables-legumes-estimate-from-ingredients_serving") double? fruitsVegetablesLegumesEstimateFromIngredientsServing,@NumConverter()@JsonKey(name: "fruits-vegetables-nuts-estimate-from-ingredients_100g") double? fruitsVegetablesNutsEstimateFromIngredients100G,@NumConverter()@JsonKey(name: "fruits-vegetables-nuts-estimate-from-ingredients_serving") double? fruitsVegetablesNutsEstimateFromIngredientsServing,@IntConverter()@JsonKey(name: "nutrition-score-fr") int? nutritionScoreFr,@IntConverter()@JsonKey(name: "nutrition-score-fr_100g") int? nutritionScoreFr100G,@NumConverter()@JsonKey(name: "proteins") double? proteins,@NumConverter()@JsonKey(name: "proteins_100g") double? proteins100G,@NumConverter()@JsonKey(name: "proteins_serving") double? proteinsServing,@JsonKey(name: "proteins_unit") String? proteinsUnit,@NumConverter()@JsonKey(name: "proteins_value") double? proteinsValue,@NumConverter()@JsonKey(name: "salt") double? salt,@NumConverter()@JsonKey(name: "salt_100g") double? salt100G,@NumConverter()@JsonKey(name: "salt_serving") double? saltServing,@JsonKey(name: "salt_unit") String? saltUnit,@NumConverter()@JsonKey(name: "salt_value") double? saltValue,@NumConverter()@JsonKey(name: "saturated-fat") double? saturatedFat,@NumConverter()@JsonKey(name: "saturated-fat_100g") double? saturatedFat100G,@NumConverter()@JsonKey(name: "saturated-fat_serving") double? saturatedFatServing,@JsonKey(name: "saturated-fat_unit") String? saturatedFatUnit,@NumConverter()@JsonKey(name: "saturated-fat_value") double? saturatedFatValue,@NumConverter()@JsonKey(name: "sodium") double? sodium,@NumConverter()@JsonKey(name: "sodium_100g") double? sodium100G,@NumConverter()@JsonKey(name: "sodium_serving") double? sodiumServing,@JsonKey(name: "sodium_unit") String? sodiumUnit,@NumConverter()@JsonKey(name: "sodium_value") double? sodiumValue,@NumConverter()@JsonKey(name: "sugars") double? sugars,@NumConverter()@JsonKey(name: "sugars_100g") double? sugars100G,@NumConverter()@JsonKey(name: "sugars_serving") double? sugarsServing,@JsonKey(name: "sugars_unit") String? sugarsUnit,@NumConverter()@JsonKey(name: "sugars_value") double? sugarsValue,@NumConverter()@JsonKey(name: "calcium") double? calcium,@NumConverter()@JsonKey(name: "calcium_100g") double? calcium100G,@JsonKey(name: "calcium_label") String? calciumLabel,@NumConverter()@JsonKey(name: "calcium_serving") double? calciumServing,@JsonKey(name: "calcium_unit") String? calciumUnit,@NumConverter()@JsonKey(name: "calcium_value") double? calciumValue,@JsonKey(name: "fat_label") String? fatLabel,@IntConverter()@JsonKey(name: "nova-group") int? novaGroup,@IntConverter()@JsonKey(name: "nova-group_100g") int? novaGroup100G,@IntConverter()@JsonKey(name: "nova-group_serving") int? novaGroupServing
});
...
as double?,energyKcalUnit: freezed == energyKcalUnit ? _self.energyKcalUnit : energyKcalUnit // ignore: cast_nullable_to_non_nullable
...
as double?,energyKcalValueComputed: freezed == energyKcalValueComputed ? _self.energyKcalValueComputed : energyKcalValueComputed // ignore: cast_nullable_to_non_nullable
as double?,energyKj: freezed == energyKj ? _self.energyKj : energyKj // ignore: cast_nullable_to_non_nullable
as double?,energyKj100G: freezed == energyKj100G ? _self.energyKj100G : energyKj100G // ignore: cast_nullable_to_non_nullable
as double?,energyKjServing: freezed == energyKjServing ? _self.energyKjServing : energyKjServing // ignore: cast_nullable_to_non_nullable
as double?,energyKjUnit: freezed == energyKjUnit ? _self.energyKjUnit : energyKjUnit // ignore: cast_nullable_to_non_nullable
...
as double?,energyServing: freezed == energyServing ? _self.energyServing : energyServing // ignore: cast_nullable_to_non_nullable
as double?,energyUnit: freezed == energyUnit ? _self.energyUnit : energyUnit // ignore: cast_nullable_to_non_nullable
...
as double?,fiberUnit: freezed == fiberUnit ? _self.fiberUnit : fiberUnit // ignore: cast_nullable_to_non_nullable
...
as double?,fruitsVegetablesLegumesEstimateFromIngredientsServing: freezed == fruitsVegetablesLegumesEstimateFromIngredientsServing ? _self.fruitsVegetablesLegumesEstimateFromIngredientsServing : fruitsVegetablesLegumesEstimateFromIngredientsServing // ignore: cast_nullable_to_non_nullable
as double?,fruitsVegetablesNutsEstimateFromIngredients100G: freezed == fruitsVegetablesNutsEstimateFromIngredients100G ? _self.fruitsVegetablesNutsEstimateFromIngredients100G : fruitsVegetablesNutsEstimateFromIngredients100G // ignore: cast_nullable_to_non_nullable
as double?,fruitsVegetablesNutsEstimateFromIngredientsServing: freezed == fruitsVegetablesNutsEstimateFromIngredientsServing ? _self.fruitsVegetablesNutsEstimateFromIngredientsServing : fruitsVegetablesNutsEstimateFromIngredientsServing // ignore: cast_nullable_to_non_nullable
as double?,nutritionScoreFr: freezed == nutritionScoreFr ? _self.nutritionScoreFr : nutritionScoreFr // ignore: cast_nullable_to_non_nullable
...
as double?,proteinsUnit: freezed == proteinsUnit ? _self.proteinsUnit : proteinsUnit // ignore: cast_nullable_to_non_nullable
...
as double?,saltUnit: freezed == saltUnit ? _self.saltUnit : saltUnit // ignore: cast_nullable_to_non_nullable
...
as double?,saturatedFatUnit: freezed == saturatedFatUnit ? _self.saturatedFatUnit : saturatedFatUnit // ignore: cast_nullable_to_non_nullable
...
as double?,sodiumUnit: freezed == sodiumUnit ? _self.sodiumUnit : sodiumUnit // ignore: cast_nullable_to_non_nullable
...
as double?,sugarsUnit: freezed == sugarsUnit ? _self.sugarsUnit : sugarsUnit // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@NumConverter()@JsonKey(name: "carbohydrates")  double? carbohydrates, @NumConverter()@JsonKey(name: "carbohydrates_100g")  double? carbohydrates100G, @NumConverter()@JsonKey(name: "carbohydrates_serving")  double? carbohydratesServing, @JsonKey(name: "carbohydrates_unit")  String? carbohydratesUnit, @NumConverter()@JsonKey(name: "carbohydrates_value")  double? carbohydratesValue, @NumConverter()@JsonKey(name: "energy")  double? energy, @NumConverter()@JsonKey(name: "energy-kcal")  double? energyKcal, @NumConverter()@JsonKey(name: "energy-kcal_100g")  double? energyKcal100G, @NumConverter()@JsonKey(name: "energy-kcal_serving")  double? energyKcalServing, @JsonKey(name: "energy-kcal_unit")  String? energyKcalUnit, @NumConverter()@JsonKey(name: "energy-kcal_value")  double? energyKcalValue, @NumConverter()@JsonKey(name: "energy-kcal_value_computed")  double? energyKcalValueComputed, @NumConverter()@JsonKey(name: "energy-kj")  double? energyKj, @NumConverter()@JsonKey(name: "energy-kj_100g")  double? energyKj100G, @NumConverter()@JsonKey(name: "energy-kj_serving")  double? energyKjServing, @JsonKey(name: "energy-kj_unit")  String? energyKjUnit, @NumConverter()@JsonKey(name: "energy-kj_value")  double? energyKjValue, @NumConverter()@JsonKey(name: "energy-kj_value_computed")  double? energyKjValueComputed, @NumConverter()@JsonKey(name: "energy_100g")  double? energy100G, @NumConverter()@JsonKey(name: "energy_serving")  double? energyServing, @JsonKey(name: "energy_unit")  String? energyUnit, @NumConverter()@JsonKey(name: "energy_value")  double? energyValue, @NumConverter()@JsonKey(name: "fat")  double? fat, @NumConverter()@JsonKey(name: "fat_100g")  double? fat100G, @NumConverter()@JsonKey(name: "fat_serving")  double? fatServing, @JsonKey(name: "fat_unit")  String? fatUnit, @NumConverter()@JsonKey(name: "fat_value")  double? fatValue, @NumConverter()@JsonKey(name: "fiber")  double? fiber, @NumConverter()@JsonKey(name: "fiber_100g")  double? fiber100G, @NumConverter()@JsonKey(name: "fiber_serving")  double? fiberServing, @JsonKey(name: "fiber_unit")  String? fiberUnit, @NumConverter()@JsonKey(name: "fiber_value")  double? fiberValue, @NumConverter()@JsonKey(name: "fruits-vegetables-legumes-estimate-from-ingredients_100g")  double? fruitsVegetablesLegumesEstimateFromIngredients100G, @NumConverter()@JsonKey(name: "fruits-vegetables-legumes-estimate-from-ingredients_serving")  double? fruitsVegetablesLegumesEstimateFromIngredientsServing, @NumConverter()@JsonKey(name: "fruits-vegetables-nuts-estimate-from-ingredients_100g")  double? fruitsVegetablesNutsEstimateFromIngredients100G, @NumConverter()@JsonKey(name: "fruits-vegetables-nuts-estimate-from-ingredients_serving")  double? fruitsVegetablesNutsEstimateFromIngredientsServing, @IntConverter()@JsonKey(name: "nutrition-score-fr")  int? nutritionScoreFr, @IntConverter()@JsonKey(name: "nutrition-score-fr_100g")  int? nutritionScoreFr100G, @NumConverter()@JsonKey(name: "proteins")  double? proteins, @NumConverter()@JsonKey(name: "proteins_100g")  double? proteins100G, @NumConverter()@JsonKey(name: "proteins_serving")  double? proteinsServing, @JsonKey(name: "proteins_unit")  String? proteinsUnit, @NumConverter()@JsonKey(name: "proteins_value")  double? proteinsValue, @NumConverter()@JsonKey(name: "salt")  double? salt, @NumConverter()@JsonKey(name: "salt_100g")  double? salt100G, @NumConverter()@JsonKey(name: "salt_serving")  double? saltServing, @JsonKey(name: "salt_unit")  String? saltUnit, @NumConverter()@JsonKey(name: "salt_value")  double? saltValue, @NumConverter()@JsonKey(name: "saturated-fat")  double? saturatedFat, @NumConverter()@JsonKey(name: "saturated-fat_100g")  double? saturatedFat100G, @NumConverter()@JsonKey(name: "saturated-fat_serving")  double? saturatedFatServing, @JsonKey(name: "saturated-fat_unit")  String? saturatedFatUnit, @NumConverter()@JsonKey(name: "saturated-fat_value")  double? saturatedFatValue, @NumConverter()@JsonKey(name: "sodium")  double? sodium, @NumConverter()@JsonKey(name: "sodium_100g")  double? sodium100G, @NumConverter()@JsonKey(name: "sodium_serving")  double? sodiumServing, @JsonKey(name: "sodium_unit")  String? sodiumUnit, @NumConverter()@JsonKey(name: "sodium_value")  double? sodiumValue, @NumConverter()@JsonKey(name: "sugars")  double? sugars, @NumConverter()@JsonKey(name: "sugars_100g")  double? sugars100G, @NumConverter()@JsonKey(name: "sugars_serving")  double? sugarsServing, @JsonKey(name: "sugars_unit")  String? sugarsUnit, @NumConverter()@JsonKey(name: "sugars_value")  double? sugarsValue, @NumConverter()@JsonKey(name: "calcium")  double? calcium, @NumConverter()@JsonKey(name: "calcium_100g")  double? calcium100G, @JsonKey(name: "calcium_label")  String? calciumLabel, @NumConverter()@JsonKey(name: "calcium_serving")  double? calciumServing, @JsonKey(name: "calcium_unit")  String? calciumUnit, @NumConverter()@JsonKey(name: "calcium_value")  double? calciumValue, @JsonKey(name: "fat_label")  String? fatLabel, @IntConverter()@JsonKey(name: "nova-group")  int? novaGroup, @IntConverter()@JsonKey(name: "nova-group_100g")  int? novaGroup100G, @IntConverter()@JsonKey(name: "nova-group_serving")  int? novaGroupServing)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Nutriments() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@NumConverter()@JsonKey(name: "carbohydrates")  double? carbohydrates, @NumConverter()@JsonKey(name: "carbohydrates_100g")  double? carbohydrates100G, @NumConverter()@JsonKey(name: "carbohydrates_serving")  double? carbohydratesServing, @JsonKey(name: "carbohydrates_unit")  String? carbohydratesUnit, @NumConverter()@JsonKey(name: "carbohydrates_value")  double? carbohydratesValue, @NumConverter()@JsonKey(name: "energy")  double? energy, @NumConverter()@JsonKey(name: "energy-kcal")  double? energyKcal, @NumConverter()@JsonKey(name: "energy-kcal_100g")  double? energyKcal100G, @NumConverter()@JsonKey(name: "energy-kcal_serving")  double? energyKcalServing, @JsonKey(name: "energy-kcal_unit")  String? energyKcalUnit, @NumConverter()@JsonKey(name: "energy-kcal_value")  double? energyKcalValue, @NumConverter()@JsonKey(name: "energy-kcal_value_computed")  double? energyKcalValueComputed, @NumConverter()@JsonKey(name: "energy-kj")  double? energyKj, @NumConverter()@JsonKey(name: "energy-kj_100g")  double? energyKj100G, @NumConverter()@JsonKey(name: "energy-kj_serving")  double? energyKjServing, @JsonKey(name: "energy-kj_unit")  String? energyKjUnit, @NumConverter()@JsonKey(name: "energy-kj_value")  double? energyKjValue, @NumConverter()@JsonKey(name: "energy-kj_value_computed")  double? energyKjValueComputed, @NumConverter()@JsonKey(name: "energy_100g")  double? energy100G, @NumConverter()@JsonKey(name: "energy_serving")  double? energyServing, @JsonKey(name: "energy_unit")  String? energyUnit, @NumConverter()@JsonKey(name: "energy_value")  double? energyValue, @NumConverter()@JsonKey(name: "fat")  double? fat, @NumConverter()@JsonKey(name: "fat_100g")  double? fat100G, @NumConverter()@JsonKey(name: "fat_serving")  double? fatServing, @JsonKey(name: "fat_unit")  String? fatUnit, @NumConverter()@JsonKey(name: "fat_value")  double? fatValue, @NumConverter()@JsonKey(name: "fiber")  double? fiber, @NumConverter()@JsonKey(name: "fiber_100g")  double? fiber100G, @NumConverter()@JsonKey(name: "fiber_serving")  double? fiberServing, @JsonKey(name: "fiber_unit")  String? fiberUnit, @NumConverter()@JsonKey(name: "fiber_value")  double? fiberValue, @NumConverter()@JsonKey(name: "fruits-vegetables-legumes-estimate-from-ingredients_100g")  double? fruitsVegetablesLegumesEstimateFromIngredients100G, @NumConverter()@JsonKey(name: "fruits-vegetables-legumes-estimate-from-ingredients_serving")  double? fruitsVegetablesLegumesEstimateFromIngredientsServing, @NumConverter()@JsonKey(name: "fruits-vegetables-nuts-estimate-from-ingredients_100g")  double? fruitsVegetablesNutsEstimateFromIngredients100G, @NumConverter()@JsonKey(name: "fruits-vegetables-nuts-estimate-from-ingredients_serving")  double? fruitsVegetablesNutsEstimateFromIngredientsServing, @IntConverter()@JsonKey(name: "nutrition-score-fr")  int? nutritionScoreFr, @IntConverter()@JsonKey(name: "nutrition-score-fr_100g")  int? nutritionScoreFr100G, @NumConverter()@JsonKey(name: "proteins")  double? proteins, @NumConverter()@JsonKey(name: "proteins_100g")  double? proteins100G, @NumConverter()@JsonKey(name: "proteins_serving")  double? proteinsServing, @JsonKey(name: "proteins_unit")  String? proteinsUnit, @NumConverter()@JsonKey(name: "proteins_value")  double? proteinsValue, @NumConverter()@JsonKey(name: "salt")  double? salt, @NumConverter()@JsonKey(name: "salt_100g")  double? salt100G, @NumConverter()@JsonKey(name: "salt_serving")  double? saltServing, @JsonKey(name: "salt_unit")  String? saltUnit, @NumConverter()@JsonKey(name: "salt_value")  double? saltValue, @NumConverter()@JsonKey(name: "saturated-fat")  double? saturatedFat, @NumConverter()@JsonKey(name: "saturated-fat_100g")  double? saturatedFat100G, @NumConverter()@JsonKey(name: "saturated-fat_serving")  double? saturatedFatServing, @JsonKey(name: "saturated-fat_unit")  String? saturatedFatUnit, @NumConverter()@JsonKey(name: "saturated-fat_value")  double? saturatedFatValue, @NumConverter()@JsonKey(name: "sodium")  double? sodium, @NumConverter()@JsonKey(name: "sodium_100g")  double? sodium100G, @NumConverter()@JsonKey(name: "sodium_serving")  double? sodiumServing, @JsonKey(name: "sodium_unit")  String? sodiumUnit, @NumConverter()@JsonKey(name: "sodium_value")  double? sodiumValue, @NumConverter()@JsonKey(name: "sugars")  double? sugars, @NumConverter()@JsonKey(name: "sugars_100g")  double? sugars100G, @NumConverter()@JsonKey(name: "sugars_serving")  double? sugarsServing, @JsonKey(name: "sugars_unit")  String? sugarsUnit, @NumConverter()@JsonKey(name: "sugars_value")  double? sugarsValue, @NumConverter()@JsonKey(name: "calcium")  double? calcium, @NumConverter()@JsonKey(name: "calcium_100g")  double? calcium100G, @JsonKey(name: "calcium_label")  String? calciumLabel, @NumConverter()@JsonKey(name: "calcium_serving")  double? calciumServing, @JsonKey(name: "calcium_unit")  String? calciumUnit, @NumConverter()@JsonKey(name: "calcium_value")  double? calciumValue, @JsonKey(name: "fat_label")  String? fatLabel, @IntConverter()@JsonKey(name: "nova-group")  int? novaGroup, @IntConverter()@JsonKey(name: "nova-group_100g")  int? novaGroup100G, @IntConverter()@JsonKey(name: "nova-group_serving")  int? novaGroupServing)  $default,) {final _that = this;
switch (_that) {
case _Nutriments():
return $default(_that.carbohydrates,_that.carbohydrates100G,_that.carbohydratesServing,_that.carbohydratesUnit,_that.carbohydratesValue,_that.energy,_that.energyKcal,_that.energyKcal100G,_that.energyKcalServing,_that.energyKcalUnit,_that.energyKcalValue,_that.energyKcalValueComputed,_that.energyKj,_that.energyKj100G,_that.energyKjServing,_that.energyKjUnit,_that.energyKjValue,_that.energyKjValueComputed,_that.energy100G,_that.energyServing,_that.energyUnit,_that.energyValue,_that.fat,_that.fat100G,_that.fatServing,_that.fatUnit,_that.fatValue,_that.fiber,_that.fiber100G,_that.fiberServing,_that.fiberUnit,_that.fiberValue,_that.fruitsVegetablesLegumesEstimateFromIngredients100G,_that.fruitsVegetablesLegumesEstimateFromIngredientsServing,_that.fruitsVegetablesNutsEstimateFromIngredients100G,_that.fruitsVegetablesNutsEstimateFromIngredientsServing,_that.nutritionScoreFr,_that.nutritionScoreFr100G,_that.proteins,_that.proteins100G,_that.proteinsServing,_that.proteinsUnit,_that.proteinsValue,_that.salt,_that.salt100G,_that.saltServing,_that.saltUnit,_that.saltValue,_that.saturatedFat,_that.saturatedFat100G,_that.saturatedFatServing,_that.saturatedFatUnit,_that.saturatedFatValue,_that.sodium,_that.sodium100G,_that.sodiumServing,_that.sodiumUnit,_that.sodiumValue,_that.sugars,_that.sugars100G,_that.sugarsServing,_that.sugarsUnit,_that.sugarsValue,_that.calcium,_that.calcium100G,_that.calciumLabel,_that.calciumServing,_that.calciumUnit,_that.calciumValue,_that.fatLabel,_that.novaGroup,_that.novaGroup100G,_that.novaGroupServing);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@NumConverter()@JsonKey(name: "carbohydrates")  double? carbohydrates, @NumConverter()@JsonKey(name: "carbohydrates_100g")  double? carbohydrates100G, @NumConverter()@JsonKey(name: "carbohydrates_serving")  double? carbohydratesServing, @JsonKey(name: "carbohydrates_unit")  String? carbohydratesUnit, @NumConverter()@JsonKey(name: "carbohydrates_value")  double? carbohydratesValue, @NumConverter()@JsonKey(name: "energy")  double? energy, @NumConverter()@JsonKey(name: "energy-kcal")  double? energyKcal, @NumConverter()@JsonKey(name: "energy-kcal_100g")  double? energyKcal100G, @NumConverter()@JsonKey(name: "energy-kcal_serving")  double? energyKcalServing, @JsonKey(name: "energy-kcal_unit")  String? energyKcalUnit, @NumConverter()@JsonKey(name: "energy-kcal_value")  double? energyKcalValue, @NumConverter()@JsonKey(name: "energy-kcal_value_computed")  double? energyKcalValueComputed, @NumConverter()@JsonKey(name: "energy-kj")  double? energyKj, @NumConverter()@JsonKey(name: "energy-kj_100g")  double? energyKj100G, @NumConverter()@JsonKey(name: "energy-kj_serving")  double? energyKjServing, @JsonKey(name: "energy-kj_unit")  String? energyKjUnit, @NumConverter()@JsonKey(name: "energy-kj_value")  double? energyKjValue, @NumConverter()@JsonKey(name: "energy-kj_value_computed")  double? energyKjValueComputed, @NumConverter()@JsonKey(name: "energy_100g")  double? energy100G, @NumConverter()@JsonKey(name: "energy_serving")  double? energyServing, @JsonKey(name: "energy_unit")  String? energyUnit, @NumConverter()@JsonKey(name: "energy_value")  double? energyValue, @NumConverter()@JsonKey(name: "fat")  double? fat, @NumConverter()@JsonKey(name: "fat_100g")  double? fat100G, @NumConverter()@JsonKey(name: "fat_serving")  double? fatServing, @JsonKey(name: "fat_unit")  String? fatUnit, @NumConverter()@JsonKey(name: "fat_value")  double? fatValue, @NumConverter()@JsonKey(name: "fiber")  double? fiber, @NumConverter()@JsonKey(name: "fiber_100g")  double? fiber100G, @NumConverter()@JsonKey(name: "fiber_serving")  double? fiberServing, @JsonKey(name: "fiber_unit")  String? fiberUnit, @NumConverter()@JsonKey(name: "fiber_value")  double? fiberValue, @NumConverter()@JsonKey(name: "fruits-vegetables-legumes-estimate-from-ingredients_100g")  double? fruitsVegetablesLegumesEstimateFromIngredients100G, @NumConverter()@JsonKey(name: "fruits-vegetables-legumes-estimate-from-ingredients_serving")  double? fruitsVegetablesLegumesEstimateFromIngredientsServing, @NumConverter()@JsonKey(name: "fruits-vegetables-nuts-estimate-from-ingredients_100g")  double? fruitsVegetablesNutsEstimateFromIngredients100G, @NumConverter()@JsonKey(name: "fruits-vegetables-nuts-estimate-from-ingredients_serving")  double? fruitsVegetablesNutsEstimateFromIngredientsServing, @IntConverter()@JsonKey(name: "nutrition-score-fr")  int? nutritionScoreFr, @IntConverter()@JsonKey(name: "nutrition-score-fr_100g")  int? nutritionScoreFr100G, @NumConverter()@JsonKey(name: "proteins")  double? proteins, @NumConverter()@JsonKey(name: "proteins_100g")  double? proteins100G, @NumConverter()@JsonKey(name: "proteins_serving")  double? proteinsServing, @JsonKey(name: "proteins_unit")  String? proteinsUnit, @NumConverter()@JsonKey(name: "proteins_value")  double? proteinsValue, @NumConverter()@JsonKey(name: "salt")  double? salt, @NumConverter()@JsonKey(name: "salt_100g")  double? salt100G, @NumConverter()@JsonKey(name: "salt_serving")  double? saltServing, @JsonKey(name: "salt_unit")  String? saltUnit, @NumConverter()@JsonKey(name: "salt_value")  double? saltValue, @NumConverter()@JsonKey(name: "saturated-fat")  double? saturatedFat, @NumConverter()@JsonKey(name: "saturated-fat_100g")  double? saturatedFat100G, @NumConverter()@JsonKey(name: "saturated-fat_serving")  double? saturatedFatServing, @JsonKey(name: "saturated-fat_unit")  String? saturatedFatUnit, @NumConverter()@JsonKey(name: "saturated-fat_value")  double? saturatedFatValue, @NumConverter()@JsonKey(name: "sodium")  double? sodium, @NumConverter()@JsonKey(name: "sodium_100g")  double? sodium100G, @NumConverter()@JsonKey(name: "sodium_serving")  double? sodiumServing, @JsonKey(name: "sodium_unit")  String? sodiumUnit, @NumConverter()@JsonKey(name: "sodium_value")  double? sodiumValue, @NumConverter()@JsonKey(name: "sugars")  double? sugars, @NumConverter()@JsonKey(name: "sugars_100g")  double? sugars100G, @NumConverter()@JsonKey(name: "sugars_serving")  double? sugarsServing, @JsonKey(name: "sugars_unit")  String? sugarsUnit, @NumConverter()@JsonKey(name: "sugars_value")  double? sugarsValue, @NumConverter()@JsonKey(name: "calcium")  double? calcium, @NumConverter()@JsonKey(name: "calcium_100g")  double? calcium100G, @JsonKey(name: "calcium_label")  String? calciumLabel, @NumConverter()@JsonKey(name: "calcium_serving")  double? calciumServing, @JsonKey(name: "calcium_unit")  String? calciumUnit, @NumConverter()@JsonKey(name: "calcium_value")  double? calciumValue, @JsonKey(name: "fat_label")  String? fatLabel, @IntConverter()@JsonKey(name: "nova-group")  int? novaGroup, @IntConverter()@JsonKey(name: "nova-group_100g")  int? novaGroup100G, @IntConverter()@JsonKey(name: "nova-group_serving")  int? novaGroupServing)?  $default,) {final _that = this;
switch (_that) {
case _Nutriments() when $default != null:
return $default(_that.carbohydrates,_that.carbohydrates100G,_that.carbohydratesServing,_that.carbohydratesUnit,_that.carbohydratesValue,_that.energy,_that.energyKcal,_that.energyKcal100G,_that.energyKcalServing,_that.energyKcalUnit,_that.energyKcalValue,_that.energyKcalValueComputed,_that.energyKj,_that.energyKj100G,_that.energyKjServing,_that.energyKjUnit,_that.energyKjValue,_that.energyKjValueComputed,_that.energy100G,_that.energyServing,_that.energyUnit,_that.energyValue,_that.fat,_that.fat100G,_that.fatServing,_that.fatUnit,_that.fatValue,_that.fiber,_that.fiber100G,_that.fiberServing,_that.fiberUnit,_that.fiberValue,_that.fruitsVegetablesLegumesEstimateFromIngredients100G,_that.fruitsVegetablesLegumesEstimateFromIngredientsServing,_that.fruitsVegetablesNutsEstimateFromIngredients100G,_that.fruitsVegetablesNutsEstimateFromIngredientsServing,_that.nutritionScoreFr,_that.nutritionScoreFr100G,_that.proteins,_that.proteins100G,_that.proteinsServing,_that.proteinsUnit,_that.proteinsValue,_that.salt,_that.salt100G,_that.saltServing,_that.saltUnit,_that.saltValue,_that.saturatedFat,_that.saturatedFat100G,_that.saturatedFatServing,_that.saturatedFatUnit,_that.saturatedFatValue,_that.sodium,_that.sodium100G,_that.sodiumServing,_that.sodiumUnit,_that.sodiumValue,_that.sugars,_that.sugars100G,_that.sugarsServing,_that.sugarsUnit,_that.sugarsValue,_that.calcium,_that.calcium100G,_that.calciumLabel,_that.calciumServing,_that.calciumUnit,_that.calciumValue,_that.fatLabel,_that.novaGroup,_that.novaGroup100G,_that.novaGroupServing);case _:
  return null;
...
class _Nutriments implements Nutriments {
  const _Nutriments({@NumConverter()@JsonKey(name: "carbohydrates") this.carbohydrates, @NumConverter()@JsonKey(name: "carbohydrates_100g") this.carbohydrates100G, @NumConverter()@JsonKey(name: "carbohydrates_serving") this.carbohydratesServing, @JsonKey(name: "carbohydrates_unit") this.carbohydratesUnit, @NumConverter()@JsonKey(name: "carbohydrates_value") this.carbohydratesValue, @NumConverter()@JsonKey(name: "energy") this.energy, @NumConverter()@JsonKey(name: "energy-kcal") this.energyKcal, @NumConverter()@JsonKey(name: "energy-kcal_100g") this.energyKcal100G, @NumConverter()@JsonKey(name: "energy-kcal_serving") this.energyKcalServing, @JsonKey(name: "energy-kcal_unit") this.energyKcalUnit, @NumConverter()@JsonKey(name: "energy-kcal_value") this.energyKcalValue, @NumConverter()@JsonKey(name: "energy-kcal_value_computed") this.energyKcalValueComputed, @NumConverter()@JsonKey(name: "energy-kj") this.energyKj, @NumConverter()@JsonKey(name: "energy-kj_100g") this.energyKj100G, @NumConverter()@JsonKey(name: "energy-kj_serving") this.energyKjServing, @JsonKey(name: "energy-kj_unit") this.energyKjUnit, @NumConverter()@JsonKey(name: "energy-kj_value") this.energyKjValue, @NumConverter()@JsonKey(name: "energy-kj_value_computed") this.energyKjValueComputed, @NumConverter()@JsonKey(name: "energy_100g") this.energy100G, @NumConverter()@JsonKey(name: "energy_serving") this.energyServing, @JsonKey(name: "energy_unit") this.energyUnit, @NumConverter()@JsonKey(name: "energy_value") this.energyValue, @NumConverter()@JsonKey(name: "fat") this.fat, @NumConverter()@JsonKey(name: "fat_100g") this.fat100G, @NumConverter()@JsonKey(name: "fat_serving") this.fatServing, @JsonKey(name: "fat_unit") this.fatUnit, @NumConverter()@JsonKey(name: "fat_value") this.fatValue, @NumConverter()@JsonKey(name: "fiber") this.fiber, @NumConverter()@JsonKey(name: "fiber_100g") this.fiber100G, @NumConverter()@JsonKey(name: "fiber_serving") this.fiberServing, @JsonKey(name: "fiber_unit") this.fiberUnit, @NumConverter()@JsonKey(name: "fiber_value") this.fiberValue, @NumConverter()@JsonKey(name: "fruits-vegetables-legumes-estimate-from-ingredients_100g") this.fruitsVegetablesLegumesEstimateFromIngredients100G, @NumConverter()@JsonKey(name: "fruits-vegetables-legumes-estimate-from-ingredients_serving") this.fruitsVegetablesLegumesEstimateFromIngredientsServing, @NumConverter()@JsonKey(name: "fruits-vegetables-nuts-estimate-from-ingredients_100g") this.fruitsVegetablesNutsEstimateFromIngredients100G, @NumConverter()@JsonKey(name: "fruits-vegetables-nuts-estimate-from-ingredients_serving") this.fruitsVegetablesNutsEstimateFromIngredientsServing, @IntConverter()@JsonKey(name: "nutrition-score-fr") this.nutritionScoreFr, @IntConverter()@JsonKey(name: "nutrition-score-fr_100g") this.nutritionScoreFr100G, @NumConverter()@JsonKey(name: "proteins") this.proteins, @NumConverter()@JsonKey(name: "proteins_100g") this.proteins100G, @NumConverter()@JsonKey(name: "proteins_serving") this.proteinsServing, @JsonKey(name: "proteins_unit") this.proteinsUnit, @NumConverter()@JsonKey(name: "proteins_value") this.proteinsValue, @NumConverter()@JsonKey(name: "salt") this.salt, @NumConverter()@JsonKey(name: "salt_100g") this.salt100G, @NumConverter()@JsonKey(name: "salt_serving") this.saltServing, @JsonKey(name: "salt_unit") this.saltUnit, @NumConverter()@JsonKey(name: "salt_value") this.saltValue, @NumConverter()@JsonKey(name: "saturated-fat") this.saturatedFat, @NumConverter()@JsonKey(name: "saturated-fat_100g") this.saturatedFat100G, @NumConverter()@JsonKey(name: "saturated-fat_serving") this.saturatedFatServing, @JsonKey(name: "saturated-fat_unit") this.saturatedFatUnit, @NumConverter()@JsonKey(name: "saturated-fat_value") this.saturatedFatValue, @NumConverter()@JsonKey(name: "sodium") this.sodium, @NumConverter()@JsonKey(name: "sodium_100g") this.sodium100G, @NumConverter()@JsonKey(name: "sodium_serving") this.sodiumServing, @JsonKey(name: "sodium_unit") this.sodiumUnit, @NumConverter()@JsonKey(name: "sodium_value") this.sodiumValue, @NumConverter()@JsonKey(name: "sugars") this.sugars, @NumConverter()@JsonKey(name: "sugars_100g") this.sugars100G, @NumConverter()@JsonKey(name: "sugars_serving") this.sugarsServing, @JsonKey(name: "sugars_unit") this.sugarsUnit, @NumConverter()@JsonKey(name: "sugars_value") this.sugarsValue, @NumConverter()@JsonKey(name: "calcium") this.calcium, @NumConverter()@JsonKey(name: "calcium_100g") this.calcium100G, @JsonKey(name: "calcium_label") this.calciumLabel, @NumConverter()@JsonKey(name: "calcium_serving") this.calciumServing, @JsonKey(name: "calcium_unit") this.calciumUnit, @NumConverter()@JsonKey(name: "calcium_value") this.calciumValue, @JsonKey(name: "fat_label") this.fatLabel, @IntConverter()@JsonKey(name: "nova-group") this.novaGroup, @IntConverter()@JsonKey(name: "nova-group_100g") this.novaGroup100G, @IntConverter()@JsonKey(name: "nova-group_serving") this.novaGroupServing});
  factory _Nutriments.fromJson(Map<String, dynamic> json) => _$NutrimentsFromJson(json);

@override@NumConverter()@JsonKey(name: "carbohydrates") final  double? carbohydrates;
@override@NumConverter()@JsonKey(name: "carbohydrates_100g") final  double? carbohydrates100G;
@override@NumConverter()@JsonKey(name: "carbohydrates_serving") final  double? carbohydratesServing;
@override@JsonKey(name: "carbohydrates_unit") final  String? carbohydratesUnit;
@override@NumConverter()@JsonKey(name: "carbohydrates_value") final  double? carbohydratesValue;
@override@NumConverter()@JsonKey(name: "energy") final  double? energy;
@override@NumConverter()@JsonKey(name: "energy-kcal") final  double? energyKcal;
@override@NumConverter()@JsonKey(name: "energy-kcal_100g") final  double? energyKcal100G;
@override@NumConverter()@JsonKey(name: "energy-kcal_serving") final  double? energyKcalServing;
@override@JsonKey(name: "energy-kcal_unit") final  String? energyKcalUnit;
@override@NumConverter()@JsonKey(name: "energy-kcal_value") final  double? energyKcalValue;
@override@NumConverter()@JsonKey(name: "energy-kcal_value_computed") final  double? energyKcalValueComputed;
@override@NumConverter()@JsonKey(name: "energy-kj") final  double? energyKj;
@override@NumConverter()@JsonKey(name: "energy-kj_100g") final  double? energyKj100G;
@override@NumConverter()@JsonKey(name: "energy-kj_serving") final  double? energyKjServing;
@override@JsonKey(name: "energy-kj_unit") final  String? energyKjUnit;
@override@NumConverter()@JsonKey(name: "energy-kj_value") final  double? energyKjValue;
@override@NumConverter()@JsonKey(name: "energy-kj_value_computed") final  double? energyKjValueComputed;
@override@NumConverter()@JsonKey(name: "energy_100g") final  double? energy100G;
@override@NumConverter()@JsonKey(name: "energy_serving") final  double? energyServing;
@override@JsonKey(name: "energy_unit") final  String? energyUnit;
@override@NumConverter()@JsonKey(name: "energy_value") final  double? energyValue;
@override@NumConverter()@JsonKey(name: "fat") final  double? fat;
@override@NumConverter()@JsonKey(name: "fat_100g") final  double? fat100G;
@override@NumConverter()@JsonKey(name: "fat_serving") final  double? fatServing;
@override@JsonKey(name: "fat_unit") final  String? fatUnit;
@override@NumConverter()@JsonKey(name: "fat_value") final  double? fatValue;
@override@NumConverter()@JsonKey(name: "fiber") final  double? fiber;
@override@NumConverter()@JsonKey(name: "fiber_100g") final  double? fiber100G;
@override@NumConverter()@JsonKey(name: "fiber_serving") final  double? fiberServing;
@override@JsonKey(name: "fiber_unit") final  String? fiberUnit;
@override@NumConverter()@JsonKey(name: "fiber_value") final  double? fiberValue;
@override@NumConverter()@JsonKey(name: "fruits-vegetables-legumes-estimate-from-ingredients_100g") final  double? fruitsVegetablesLegumesEstimateFromIngredients100G;
@override@NumConverter()@JsonKey(name: "fruits-vegetables-legumes-estimate-from-ingredients_serving") final  double? fruitsVegetablesLegumesEstimateFromIngredientsServing;
@override@NumConverter()@JsonKey(name: "fruits-vegetables-nuts-estimate-from-ingredients_100g") final  double? fruitsVegetablesNutsEstimateFromIngredients100G;
@override@NumConverter()@JsonKey(name: "fruits-vegetables-nuts-estimate-from-ingredients_serving") final  double? fruitsVegetablesNutsEstimateFromIngredientsServing;
@override@IntConverter()@JsonKey(name: "nutrition-score-fr") final  int? nutritionScoreFr;
@override@IntConverter()@JsonKey(name: "nutrition-score-fr_100g") final  int? nutritionScoreFr100G;
@override@NumConverter()@JsonKey(name: "proteins") final  double? proteins;
@override@NumConverter()@JsonKey(name: "proteins_100g") final  double? proteins100G;
@override@NumConverter()@JsonKey(name: "proteins_serving") final  double? proteinsServing;
@override@JsonKey(name: "proteins_unit") final  String? proteinsUnit;
@override@NumConverter()@JsonKey(name: "proteins_value") final  double? proteinsValue;
@override@NumConverter()@JsonKey(name: "salt") final  double? salt;
@override@NumConverter()@JsonKey(name: "salt_100g") final  double? salt100G;
@override@NumConverter()@JsonKey(name: "salt_serving") final  double? saltServing;
@override@JsonKey(name: "salt_unit") final  String? saltUnit;
@override@NumConverter()@JsonKey(name: "salt_value") final  double? saltValue;
@override@NumConverter()@JsonKey(name: "saturated-fat") final  double? saturatedFat;
@override@NumConverter()@JsonKey(name: "saturated-fat_100g") final  double? saturatedFat100G;
@override@NumConverter()@JsonKey(name: "saturated-fat_serving") final  double? saturatedFatServing;
@override@JsonKey(name: "saturated-fat_unit") final  String? saturatedFatUnit;
@override@NumConverter()@JsonKey(name: "saturated-fat_value") final  double? saturatedFatValue;
@override@NumConverter()@JsonKey(name: "sodium") final  double? sodium;
@override@NumConverter()@JsonKey(name: "sodium_100g") final  double? sodium100G;
@override@NumConverter()@JsonKey(name: "sodium_serving") final  double? sodiumServing;
@override@JsonKey(name: "sodium_unit") final  String? sodiumUnit;
@override@NumConverter()@JsonKey(name: "sodium_value") final  double? sodiumValue;
@override@NumConverter()@JsonKey(name: "sugars") final  double? sugars;
@override@NumConverter()@JsonKey(name: "sugars_100g") final  double? sugars100G;
@override@NumConverter()@JsonKey(name: "sugars_serving") final  double? sugarsServing;
@override@JsonKey(name: "sugars_unit") final  String? sugarsUnit;
@override@NumConverter()@JsonKey(name: "sugars_value") final  double? sugarsValue;
@override@NumConverter()@JsonKey(name: "calcium") final  double? calcium;
@override@NumConverter()@JsonKey(name: "calcium_100g") final  double? calcium100G;
@override@JsonKey(name: "calcium_label") final  String? calciumLabel;
@override@NumConverter()@JsonKey(name: "calcium_serving") final  double? calciumServing;
@override@JsonKey(name: "calcium_unit") final  String? calciumUnit;
@override@NumConverter()@JsonKey(name: "calcium_value") final  double? calciumValue;
@override@JsonKey(name: "fat_label") final  String? fatLabel;
@override@IntConverter()@JsonKey(name: "nova-group") final  int? novaGroup;
@override@IntConverter()@JsonKey(name: "nova-group_100g") final  int? novaGroup100G;
@override@IntConverter()@JsonKey(name: "nova-group_serving") final  int? novaGroupServing;
